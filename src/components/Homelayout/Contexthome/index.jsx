...
const HomeLayout = () => {
  return (
    <motion.div
      ...
      className="px-4 md:px-12 flex flex-col items-center justify-between py-6 space-y-8"
    >
      <div className="flex flex-col md:flex-row items-center justify-between w-full">
        <div className="w-full md:w-1/2 mb-8 md:mb-0 text-center md:text-left">
          <h1 className="text-4xl md:text-6xl  text-center font-medium text-transparent bg-clip-text bg-gradient-to-r text-white mb-8">
            <span className="text-black  "></span> EL MAN <br /> DE LOS CAMIONES
          </h1>

          <hr className="border-gray-300 mb-4 md:mb-8" />
          <p className="text-white mb-10 text-justify text-sm md:text-base">
            En <span className="text-blue-500 font-semibold">nuestra empresa</span>,
