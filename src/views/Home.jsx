...
const Home = () => {
  return (
    <div>
      ...
      <section id="inicio" className="pt-24 pb-20 bg-cover bg-center relative">
      ...
      <section
        id="sobreNosotros"
        className="pt-24 pb-20 g-white bg-gradient-to-r from-[#0f172a]  to-[#334155]"
      >
        <ContactForm />
      </section>
      ...
      <section
        id="Recommendations"
        className="pt-24 pb-20 g-white  bg-gray-500"
      >
        <Recommendations />
      </section>
